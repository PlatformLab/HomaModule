...
/**
 * homa_dointvec() - This function is a wrapper around proc_dointvec, invoked
 * to read and write priority values via sysctl; it invokes proc_dointvec and
 * then calls homa_check_priorities if the value was modified.

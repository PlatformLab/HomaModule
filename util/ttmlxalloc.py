...
input. If --stats is specified, then the program outputs statistics; if
--stats is not specified, the program outputs a new time trace where
adjacent allocate/free entries have been collapsed into a single entry
for ease of reading.
Usage: ttmlxalloc.py [--stats] [file]
"""
